...
/**
 * Data type holding local data about fits filenames generated by the instrument. Lesedi FITS filenames
 * are of the form: <b>/data/lesedi/mkd/2021/0505//MKD_20210505.0001.fits</b>.
...
struct Fits_Filename_Struct
{
	...
	/** String at the start of FITS filenames representing instrument. */
	char Instrument_Code[COMPONENT_STRING_LENGTH];
	/** String containing the start of the data path used to construct the Data_Dir. */
	char Data_Dir_Root[COMPONENT_STRING_LENGTH];
	/** String containing the name of the telescope, used to construct the Data_Dir. */
	char Data_Dir_Telescope[COMPONENT_STRING_LENGTH];
	/** String containing the name of the instrument, used to construct the Data_Dir. */
	char Data_Dir_Instrument[COMPONENT_STRING_LENGTH];
	/** Current date number of the last file produced, of the form yyyymmdd. */
