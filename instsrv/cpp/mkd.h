...
#define PIO_INP_GRISM_STOW    0b00000001
#define PIO_INP_GRISM_DEPLOY  0b00000010
#define PIO_INP_SLIT_STOW     0b00000100
#define PIO_INP_SLIT_DEPLOY   0b00001000
#define PIO_INP_MIRROR_STOW   0b00010000
#define PIO_INP_MIRROR_DEPLOY 0b00100000
#define PIO_INP_AIR_PRESSURE  0b01000000
#define PIO_INP_SPARE_1       0b10000000

#define PIO_OUT_SPARE0        0b00000001
#define PIO_OUT_SPARE1        0b00000010
#define PIO_OUT_SPARE2        0b00000100
#define PIO_OUT_WLAMP_ON      0b00001000
#define PIO_OUT_ARC_ON        0b00010000
