...
{ "LAC0Filter1Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[1] ,NULL,  240, 0, 1023},
{ "LAC0Filter2Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[2] ,NULL,  430, 0, 1023},
{ "LAC0Filter3Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[3] ,NULL,  623, 0, 1023},
{ "LAC0Filter4Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[4] ,NULL,  815, 0, 1023},
{ "LAC0Filter5Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[5] ,NULL, 1015, 0, 1023},
{ "LAC1Filter0Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[0] ,NULL,   19, 0, 1023},
{ "LAC1Filter1Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[1] ,NULL,  240, 0, 1023},
{ "LAC1Filter2Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[2] ,NULL,  430, 0, 1023},
{ "LAC1Filter3Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[3] ,NULL,  260, 0, 1023},
{ "LAC1Filter4Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[4] ,NULL,  815, 0, 1023},
{ "LAC1Filter5Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[5] ,NULL, 1010, 0, 1023},
{ "LAC0Filter0Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[0],"Stowed"     ,0,0,0},
...
{ "LAC0Filter5Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[5],"LAC0Filter5",0,0,0},
{ "LAC1Filter0Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[0],"Stowed"     ,0,0,0},
...
{ "LAC1Filter5Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[5],"LAC1Filter5",0,0,0},
//
