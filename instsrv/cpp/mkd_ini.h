...
// 
{ "LAC1Filter1Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[0] ,NULL,    0, 0, 1023},
{ "LAC1Filter2Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[1] ,NULL,  256, 0, 1023},
{ "LAC1Filter3Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[2] ,NULL,  512, 0, 1023},
{ "LAC1Filter4Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[3] ,NULL,  768, 0, 1023},
{ "LAC1Filter5Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[0].pos[4] ,NULL, 1023, 0, 1023},
{ "LAC2Filter1Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[0] ,NULL,    0, 0, 1023},
{ "LAC2Filter2Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[1] ,NULL,  256, 0, 1023},
{ "LAC2Filter3Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[2] ,NULL,  512, 0, 1023},
{ "LAC2Filter4Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[3] ,NULL,  768, 0, 1023},
{ "LAC2Filter5Position",CFG_SECT_LAC, CFG_TYPE_INT, &lac_Actuator[1].pos[4] ,NULL, 1023, 0, 1023},
{ "LAC1Filter1Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[0],"LAC1Filter1",0,0,0},
{ "LAC1Filter2Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[1],"LAC1Filter2",0,0,0},
{ "LAC1Filter3Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[2],"LAC1Filter3",0,0,0},
{ "LAC1Filter4Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[3],"LAC1Filter4",0,0,0},
{ "LAC1Filter5Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[0].name[4],"LAC1Filter5",0,0,0},
{ "LAC2Filter1Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[0],"LAC2Filter1",0,0,0},
{ "LAC2Filter2Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[1],"LAC2Filter2",0,0,0},
{ "LAC2Filter3Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[2],"LAC2Filter3",0,0,0},
{ "LAC2Filter4Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[3],"LAC2Filter4",0,0,0},
{ "LAC2Filter5Name"    ,CFG_SECT_LAC, CFG_TYPE_STR, &lac_Actuator[1].name[4],"LAC2Filter5",0,0,0},
//
